...
public class BombaCombustivelController {
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "201", description = "Bomba criada com sucesso"),
          @ApiResponse(responseCode = "404",
              description = "Tipo de Combustível (pai) não encontrado")})
  @PostMapping
  @ResponseStatus(HttpStatus.CREATED)
  public BombaCombustivelResponseDTO create(
      @Valid @RequestBody BombaCombustivelRequestDTO requestDTO) {
  ...
  @PutMapping("/{id}")
  public BombaCombustivelResponseDTO update(@PathVariable Long id,
      @Valid @RequestBody BombaCombustivelRequestDTO requestDTO) {
