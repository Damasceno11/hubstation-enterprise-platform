package com.pedro.postodecombustivel.service.impl;
...
import br.com.damasceno.postodecombustivel.service.impl.BombaCombustivelServiceImpl;
...
class BombaCombustivelServiceImplTest {
    ...
    @Mock private BombaCombustivelMapper mapper;

    // Usamos @Spy no mapper real para testar o mapeamento aninhado
    @Spy private TipoCombustivelMapper tipoCombustivelMapper = new TipoCombustivelMapper();

    @InjectMocks private BombaCombustivelServiceImpl service;
